    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        textToSpeechBtn.addEventListener('click', function() {
          ...
          if (!isSpeaking) {
            ...
            speech.onstart = function() {
              isSpeaking = true;
              textToSpeechBtn.innerHTML = '<i class="fas fa-pause"></i> Pause Reading';
            ...
            speech.onend = function() {
              isSpeaking = false;
              textToSpeechBtn.innerHTML = '<i class="fas fa-volume-up"></i> Listen to this section';
      ...
      languageOptions.forEach(option => {
        option.addEventListener('click', function() {
          ...
          document.querySelector('.language-btn span').textContent = this.textContent;
      ...
      document.querySelectorAll('.pricing-select').forEach(button => {
        button.addEventListener('click', function() {
          const planTitle = this.closest('.pricing-card').querySelector('.pricing-title').textContent;
          showToast(`Thank you for selecting the ${planTitle} plan! Our team will contact you shortly.`);
          
          // Add visual feedback
          this.closest('.pricing-card').style.boxShadow = '0 0 30px rgba(138, 43, 226, 0.3)';
          setTimeout(() => {
      ...
      document.querySelectorAll('.feature-card, .pricing-card, .service-card').forEach((card) => {
      ...
      document.getElementById('cookieSettings').addEventListener('click', function(e) {
        e.preventDefault();
        showToast('Cookie preferences opened. In a real implementation, this would show a modal with cookie options.');
      });
